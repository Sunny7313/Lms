...
function fetchBookDetails($conn, $bookId)
{
...
$bookDetails = fetchBookDetails($conn, $bookId);
...
<head>
    ...
    <title>Book Details - Library App</title>
...
<body class="bg-gray-50">
    ...
    <div class="min-h-screen flex">
        ...
        <main id="main-content" class="flex-1 p-6">
            ...
            <?php displayMessagePopup(); ?>
            <section class="book-details mt-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-semibold text-gray-900">Book Details</h2>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 border border-gray-300">
                            <?php if ($bookDetails): ?>
                                <tr class="bg-gray-50 border-b border-gray-300">
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Book Cover</th>
                                    <td class="px-6 py-4 whitespace-nowrap"><img src="../photos/<?= $bookDetails['book_cover'] ?>" alt="Book cover" class="w-32 h-48 object-cover"></td>
                                </tr>
                                <tr class="border-b border-gray-300">
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Book ID</th>
                                    <td class="px-6 py-4 whitespace-nowrap"><?= $bookDetails['book_id'] ?></td>
                                </tr>
                                <tr class="bg-gray-50 border-b border-gray-300">
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Title</th>
                                    <td class="px-6 py-4 whitespace-nowrap"><?= $bookDetails['book_name'] ?></td>
                                </tr>
                                <tr class="border-b border-gray-300">
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Author</th>
                                    <td class="px-6 py-4 whitespace-nowrap"><?= $bookDetails['author_name'] ?></td>
                                </tr>
                                <tr class="bg-gray-50 border-b border-gray-300">
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Published Date</th>
                                    <td class="px-6 py-4 whitespace-nowrap"><?= $bookDetails['published_date'] ?></td>
                                </tr>
                                <tr class="border-b border-gray-300">
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Category</th>
                                    <td class="px-6 py-4 whitespace-nowrap"><?= $bookDetails['category'] ?></td>
                                </tr>
                                <tr class="bg-gray-50 border-b border-gray-300">
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Rack</th>
                                    <td class="px-6 py-4 whitespace-nowrap"><?= $bookDetails['rack'] ?></td>
                                </tr>
                                <tr class="border-b border-gray-300">
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Stock</th>
                                    <td class="px-6 py-4 whitespace-nowrap"><?= $bookDetails['stock'] ?></td>
                                </tr>
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Description</th>
                                    <td class="px-6 py-4 whitespace-nowrap"><?= $bookDetails['description'] ?></td>
                                </tr>
                            <?php else: ?>
                                <tr class="border-b border-gray-300">
                                    <td colspan="2" class="px-6 py-4 whitespace-nowrap text-center text-sm text-gray-500">Book details not found.</td>
                                </tr>
                            <?php endif; ?>
                            <tr>
                                <td colspan="2" class="px-6 py-4 whitespace-nowrap text-right">
                                    <a href="<?= $_SESSION['previous_page'] ?>" class="bg-red-600 text-white py-2 px-4 rounded-md hover:bg-red-700 transition-colors"><i class="fa fa-sign-out-alt"></i> Back to Previous Page</a>
                                </td>
                            </tr>
                        </table>
                    </div>
