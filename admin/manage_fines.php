...
{
    $query = "SELECT f.fine_id, f.fine_amount, f.due_date, b.book_name, m.username 
              FROM fines f 
              INNER JOIN books b ON f.book_id = b.book_id 
              INNER JOIN member_list m ON f.pin_number = m.pin_number";
...
<body class="bg-gray-50">
    ...
    <aside class="fixed left-0 top-0 w-64 h-full bg-white border-r border-gray-200 z-30">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="manage_fines.php" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-indigo-50 text-indigo-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <?php while ($fine = $fines->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b">
                                    ...
                                    <a href="javascript:void(0);" onclick="confirmDelete('delete_fine.php?id=<?= $fine['fine_id'] ?>')" class="text-red-500"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
