...
<head>
    ...
    <title>Manage Members - Library App</title>
    ...
    <div class="min-h-screen">
        <aside class="fixed left-0 top-0 w-64 h-full bg-white border-r border-gray-200 z-30">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="manage_members.php" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-indigo-50 text-indigo-600">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <main class="ml-64 p-6">
            <header class="bg-white border-b border-gray-200 px-8 py-4">
                <div class="flex items-center justify-between">
                    <div class="relative w-96">
                        <form method="GET" action="manage_members.php" class="relative">
                            <input
                                type="text"
                                name="search"
            ...
            <section class="bg-white p-6 rounded-md shadow-md">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <a href="add_member.php" class="btn btn-primary bg-blue-500 text-white px-4 py-2 rounded-md">Add New Member</a>
                </div>
                <table class="min-w-full bg-white border border-gray-200 rounded-md">
                    <thead>
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b">Pin Number</th>
                        ...
                        <?php if ($members): ?>
                            <?php while ($member = $members->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b"><?= $member['phone_number'] ?></td>
                                    <td class="py-2 px-4 border-b"><?= $member['pin_number'] ?></td>
                                    <td class="py-2 px-4 border-b"><?= $member['branch'] ?></td>
                                    <td class="py-2 px-4 border-b"><?= $member['year'] ?></td>
                                    <td class="py-2 px-4 border-b"><?= $member['section'] ?></td>
                                    <td class="py-2 px-4 border-b"><?= $member['role'] ?></td>
                                    <td class="py-2 px-4 border-b"><?= $member['gender'] ?></td>
                                    <td class="py-2 px-4 border-b">
                                        <a href="edit_member.php?id=<?= $member['pin_number'] ?>" class="text-blue-500"><i class="fa fa-pen"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="javascript:void(0);" onclick="confirmDelete('delete_member.php?id=<?= $member['pin_number'] ?>')" class="text-red-500"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                        <?php endif; ?>
